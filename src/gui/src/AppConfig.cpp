...
#if defined(Q_OS_WIN)
const char AppConfig::server_name_[] = "leapdesk-server.exe";
const char AppConfig::client_name_[] = "leapdesk-client.exe";
const char AppConfig::log_dir_[] = "log/";
#define DEFAULT_PROCESS_MODE Service
#else
const char AppConfig::server_name_[] = "leapdesk-server";
const char AppConfig::client_name_[] = "leapdesk-client";
...
{
    // Leapdesk KVM binaries should be in the same dir.
...
void AppConfig::loadSettings()
{
    ...
    m_LogFilename = settings().value("logFilename", log_dir() + "leapdesk.log").toString();
